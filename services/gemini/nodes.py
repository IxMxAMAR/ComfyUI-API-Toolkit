...
# ===================================================================
# CONFIG NODES  (API Toolkit/Gemini/Config)
# ===================================================================

class AIS_Gemini_APIKey(BaseAPIKeyNode):
...
class AIS_Gemini_ModelSelector:
...
class AIS_Gemini_SafetySettings:
...
class AIS_Gemini_ThinkingConfig:
...
# ===================================================================
# TEXT NODES  (API Toolkit/Gemini/Text)
# ===================================================================

class AIS_Gemini_TextGen(AlwaysExecuteMixin):
    ...
    RETURN_NAMES = ("text",)
    FUNCTION = "generate"
    CATEGORY = "API Toolkit/Gemini/Text"
...
class AIS_Gemini_PromptRefiner(AlwaysExecuteMixin):
...
class AIS_Gemini_MultiTurn(AlwaysExecuteMixin):
...
class AIS_Gemini_StructuredOutput(AlwaysExecuteMixin):
...
# ===================================================================
# VISION / IMAGE NODES  (API Toolkit/Gemini/Image)
# ===================================================================

class AIS_Gemini_Vision(AlwaysExecuteMixin):
...
class AIS_Gemini_ImageGen(AlwaysExecuteMixin):
        ...
        return {
            "required": {
                ...
                "model": (IMAGE_MODELS, {
                    ...
                    "tooltip": "Gemini image model. For Imagen models, use the dedicated Imagen Image Generation node instead.",
                }),
                "custom_model": ("STRING", {
                    "default": "",
                    "tooltip": "Override with a custom model ID.",
...
class AIS_Gemini_ImageEdit(AlwaysExecuteMixin):
...
class AIS_Gemini_Inpaint(AlwaysExecuteMixin):
...
class AIS_Gemini_Outpaint(AlwaysExecuteMixin):
...
class AIS_Gemini_TTS(AlwaysExecuteMixin):
    """Gemini Text-to-Speech. Uses generate_content with audio response modality.
    ...
    RETURN_NAMES = ("audio",)
    FUNCTION = "generate"
    CATEGORY = "API Toolkit/Gemini/Audio"
...
class AIS_Gemini_Embed(AlwaysExecuteMixin):
    ...
    FUNCTION = "embed"
    CATEGORY = "API Toolkit/Gemini/Embeddings"
...
class AIS_Gemini_VideoGen(AlwaysExecuteMixin):
    ...
    FUNCTION = "generate"
    CATEGORY = "API Toolkit/Gemini/Video"
...
class AIS_Gemini_MusicGen(AlwaysExecuteMixin):
...
class AIS_Gemini_CountTokens(AlwaysExecuteMixin):
...
NODE_CLASS_MAPPINGS = {
    ...
    "AIS_Gemini_CountTokens": AIS_Gemini_CountTokens,
    # Text (4)
    ...
    # Audio (2)
    "AIS_Gemini_TTS": AIS_Gemini_TTS,
    "AIS_Gemini_MusicGen": AIS_Gemini_MusicGen,
    # Video (1)
    "AIS_Gemini_VideoGen": AIS_Gemini_VideoGen,
    # Embeddings (1)
    "AIS_Gemini_Embed": AIS_Gemini_Embed,
}

NODE_DISPLAY_NAME_MAPPINGS = {
    # Config
    "AIS_Gemini_APIKey": "Gemini API Key",
    ...
    # Audio
    "AIS_Gemini_TTS": "Gemini Text-to-Speech",
    "AIS_Gemini_MusicGen": "Gemini Music Generation (Lyria)",
    # Video
    "AIS_Gemini_VideoGen": "Gemini Video Generation (Veo)",
    # Embeddings
    "AIS_Gemini_Embed": "Gemini Text Embeddings",
}
