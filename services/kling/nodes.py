...
from .client import KlingClient, get_client
...
def upload_to_cloud(file_content: bytes, filename: str, mime_type: str, provider: str = "catbox") -> str:
    """Upload with automatic fallback -- tries preferred provider first, falls back to the other."""
    try:
        if provider == "catbox":
...
class AIS_Kling_Auth(DualKeyAPIKeyNode):
    ...
    RETURN_NAMES = ("auth",)
    FUNCTION = "execute"
    CATEGORY = "API Toolkit/Kling AI/Config"
...
class AIS_Kling_AssetUpload(AlwaysExecuteMixin):
    @classmethod
    def INPUT_TYPES(s):
        return {"required": {
            "auth": ("KLING_AUTH",),
...
class AIS_Kling_ElementSelector:
    @classmethod
    def INPUT_TYPES(s):
        return {"required": {
...
class AIS_Kling_CloudUploader(AlwaysExecuteMixin):
    @classmethod
    def INPUT_TYPES(s):
        return {"required": {
...
class AIS_Kling_TextToVideo(AlwaysExecuteMixin):
    ...
    FUNCTION = "generate"
    CATEGORY = "API Toolkit/Kling AI/Video"
...
class AIS_Kling_ImageToVideo(AlwaysExecuteMixin):
...
class AIS_Kling_VideoOmni(AlwaysExecuteMixin):
...
class AIS_Kling_VideoExtend(AlwaysExecuteMixin):
...
class AIS_Kling_LipSync(AlwaysExecuteMixin):
...
class AIS_Kling_AvatarGen(AlwaysExecuteMixin):
...
class AIS_Kling_AdvancedLipSync(AlwaysExecuteMixin):
...
class AIS_Kling_ImageGen(AlwaysExecuteMixin):
    ...
    FUNCTION = "generate"
    CATEGORY = "API Toolkit/Kling AI/Image"
...
class AIS_Kling_ImageOmni(AlwaysExecuteMixin):
...
class AIS_Kling_ImageExtend(AlwaysExecuteMixin):
...
class AIS_Kling_VirtualTryOn(AlwaysExecuteMixin):
...
class AIS_Kling_MultiShot(AlwaysExecuteMixin):
...
class AIS_Kling_AudioGenerate(AlwaysExecuteMixin):
    ...
    FUNCTION = "generate"
    CATEGORY = "API Toolkit/Kling AI/Audio"
...
class AIS_Kling_TTS(AlwaysExecuteMixin):
...
class AIS_Kling_VideoToAudio(AlwaysExecuteMixin):
...
class AIS_Kling_Upscale(AlwaysExecuteMixin):
    ...
    FUNCTION = "generate"
    CATEGORY = "API Toolkit/Kling AI/Effects"
...
class AIS_Kling_MotionControl(AlwaysExecuteMixin):
...
class AIS_Kling_VoiceClone(AlwaysExecuteMixin):
...
class AIS_Kling_TTSAdvanced(AlwaysExecuteMixin):
...
class AIS_Kling_VideoEffects(AlwaysExecuteMixin):
...
class AIS_Kling_EffectTemplates(AlwaysExecuteMixin):
...
class AIS_Kling_ImageRecognize(AlwaysExecuteMixin):
...
class AIS_Kling_FastVideoSaver:
...
NODE_CLASS_MAPPINGS = {
    # Video
    "AIS_Kling_TextToVideo": AIS_Kling_TextToVideo,
    "AIS_Kling_ImageToVideo": AIS_Kling_ImageToVideo,
    "AIS_Kling_VideoOmni": AIS_Kling_VideoOmni,
    "AIS_Kling_VideoExtend": AIS_Kling_VideoExtend,
    "AIS_Kling_LipSync": AIS_Kling_LipSync,
    "AIS_Kling_AdvancedLipSync": AIS_Kling_AdvancedLipSync,
    "AIS_Kling_MotionControl": AIS_Kling_MotionControl,
    "AIS_Kling_AvatarGen": AIS_Kling_AvatarGen,

    # Image
    "AIS_Kling_ImageGen": AIS_Kling_ImageGen,
    "AIS_Kling_ImageOmni": AIS_Kling_ImageOmni,
    "AIS_Kling_ImageExtend": AIS_Kling_ImageExtend,
    "AIS_Kling_VirtualTryOn": AIS_Kling_VirtualTryOn,
    "AIS_Kling_MultiShot": AIS_Kling_MultiShot,
    "AIS_Kling_ImageRecognize": AIS_Kling_ImageRecognize,

    # Audio
    "AIS_Kling_AudioGenerate": AIS_Kling_AudioGenerate,
    "AIS_Kling_TTS": AIS_Kling_TTS,
    "AIS_Kling_TTSAdvanced": AIS_Kling_TTSAdvanced,
    "AIS_Kling_VideoToAudio": AIS_Kling_VideoToAudio,
    "AIS_Kling_VoiceClone": AIS_Kling_VoiceClone,

    # Effects
    "AIS_Kling_VideoEffects": AIS_Kling_VideoEffects,
    "AIS_Kling_EffectTemplates": AIS_Kling_EffectTemplates,
    "AIS_Kling_Upscale": AIS_Kling_Upscale,

    # Config
    "AIS_Kling_Auth": AIS_Kling_Auth,
    "AIS_Kling_VideoLoader": AIS_Kling_VideoLoader,
    "AIS_Kling_RawFileLoader": AIS_Kling_RawFileLoader,
    "AIS_Kling_RawFileSaver": AIS_Kling_RawFileSaver,
    "AIS_Kling_AssetUpload": AIS_Kling_AssetUpload,
    "AIS_Kling_ElementSelector": AIS_Kling_ElementSelector,
    "AIS_Kling_CameraControl": AIS_Kling_CameraControl,
    "AIS_Kling_VoiceSelector": AIS_Kling_VoiceSelector,
    "AIS_Kling_CloudUploader": AIS_Kling_CloudUploader,
    "AIS_Kling_FastVideoSaver": AIS_Kling_FastVideoSaver,
}

NODE_DISPLAY_NAME_MAPPINGS = {
    # Video
    "AIS_Kling_TextToVideo": "Kling Text to Video",
    "AIS_Kling_ImageToVideo": "Kling Image to Video",
    "AIS_Kling_VideoOmni": "Kling Video Omni",
    "AIS_Kling_VideoExtend": "Kling Video Extend",
    "AIS_Kling_LipSync": "Kling Lip Sync",
    "AIS_Kling_AdvancedLipSync": "Kling Advanced Lip Sync",
    "AIS_Kling_MotionControl": "Kling Motion Control",
    "AIS_Kling_AvatarGen": "Kling Avatar Generation",

    # Image
    "AIS_Kling_ImageGen": "Kling Image Generation",
    "AIS_Kling_ImageOmni": "Kling Image Omni",
    "AIS_Kling_ImageExtend": "Kling Image Extend",
    "AIS_Kling_VirtualTryOn": "Kling Virtual Try-On",
    "AIS_Kling_MultiShot": "Kling AI Multi-Shot",
    "AIS_Kling_ImageRecognize": "Kling Image Recognize",

    # Audio
    "AIS_Kling_AudioGenerate": "Kling Text to Audio",
    "AIS_Kling_TTS": "Kling Text to Speech",
    "AIS_Kling_TTSAdvanced": "Kling TTS Advanced",
    "AIS_Kling_VideoToAudio": "Kling Video to Audio",
    "AIS_Kling_VoiceClone": "Kling Voice Clone",

    # Effects
    "AIS_Kling_VideoEffects": "Kling Video Effects",
    "AIS_Kling_EffectTemplates": "Kling Effect Templates",
    "AIS_Kling_Upscale": "Kling AI Upscale",

    # Config
    "AIS_Kling_Auth": "Kling AI Authentication",
    "AIS_Kling_VideoLoader": "Kling Video Loader",
    "AIS_Kling_RawFileLoader": "Kling Raw File Loader",
    "AIS_Kling_RawFileSaver": "Kling Raw File Saver",
    "AIS_Kling_AssetUpload": "Kling AI Asset Upload",
    "AIS_Kling_ElementSelector": "Kling AI Element",
    "AIS_Kling_CameraControl": "Kling Camera Control",
    "AIS_Kling_VoiceSelector": "Kling Voice Selector",
    "AIS_Kling_CloudUploader": "Kling AI Cloud Uploader",
    "AIS_Kling_FastVideoSaver": "Kling Fast Video Saver",
}
